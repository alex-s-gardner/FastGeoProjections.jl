...
"""
function polarstereo_fwd(longitude::Real, latitude::Real; a::Real=6378137.0, e::Real=0.08181919, lat_ts::Real=70.0, lon_0::Real=-45.0, always_xy=true)
...
function polarstereo_inv(x::Real, y::Real; a::Real=6378137.0, e::Real=0.08181919, lat_ts::Real=70.0, lon_0::Real=-45.0, always_xy=true)
